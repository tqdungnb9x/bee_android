package calculator.b.bee.calculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initWidget() {
        ...
        btnClearE = (Button) findViewById(R.id.btnClearE);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnResult:
                ...
                // ĐOẠN CODE ĐỂ XÉT NHÂN CHIA TRƯỚC , CỘNG TRỪ SAU ( thời gian ngắn , chưa tối ưu được )
//                for (int i = arrOperation.size(); true; i--)
////                        if (arrOperation.get(i) == "*" || arrOperation.get(i) == "/")
//                            switch (arrOperation.get(i)) {
//                                case "*": {
//
//                                    arrNumber.get(i) *= arrNumber.get(i + 1);
...
//                    tvResult.setText(df.format(result) + "");
                else if (arrNumber.size() ==1) tvResult.setText(df.format(arrNumber.get(0)) + "");
                else {
                    for (int i = 0; i < (arrNumber.size() - 1); i++) {
                        switch (arrOperation.get(i)) {
                            case "+":
